...
MIDDLEWARE = [
    ...
    'core.middleware.custom_login_required_middleware.CustomLoginRequiredMiddleware',# middleware used for global login
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [],  # included 'templates' directory for django to access the html templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
LOGIN_REDIRECT_URL = 'trang-chu'                             # sets the login redirect to the 'home' page after login
